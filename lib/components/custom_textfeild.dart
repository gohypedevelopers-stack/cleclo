...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    final Color baseFill =
        widget.fillColor ??
        AppColors.transparent; // soft background like the mock
    final Color baseBorder = AppColors.gray300; // thin grey border
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: widget.enabled ? baseFill : AppColors.gray200,
        // prefix icon with gentle spacing like the screenshot
        prefixIcon: widget.prefixIcon != null
            ? Padding(
                padding: const EdgeInsetsDirectional.only(start: 12, end: 8),
                child: IconTheme(
                  data: const IconThemeData(color: AppColors.gray500, size: 22),
